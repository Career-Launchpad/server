...
export declare class ApolloServer extends ApolloServerBase {
    ...
    createHandler({ cors }?: CreateHandlerOptions): (event: APIGatewayProxyEvent, context: LambdaContext, callback: import("aws-lambda").Callback<import("aws-lambda").APIGatewayProxyResult>) => void;
}
